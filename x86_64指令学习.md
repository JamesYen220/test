...
6. 所有工作内容在 GitHub 提交
<img width="1391" alt="image" src="https://github.com/JamesYen220/test/assets/100248639/2883cc73-63e6-4f3c-aa85-a2ac2cd0c193">  
...
Create CMake
```
# Create executable of pure bubblesort written in c and executable of bubblesort written in c and assembly
cmake_minimum_required(VERSION 3.0)
# Define a project name that encompasses both executables
project(BubbleSortProjects)

# Enable C and Assembly languages
enable_language(C ASM)

# Executable for the pure C version
add_executable(bubbleSort bubbleSort.c)

# Executable for the C and Assembly version
add_executable(bubbleSortAssembly bubbleSortAssembly.c)

# Set the assembly source files
set(ASM_SOURCE_FILES bubbleSort.s)
set_source_files_properties(${ASM_SOURCE_FILES} PROPERTIES LANGUAGE ASM)

# Link the assembly file with the C file for the bubbleSortAssembly executable
target_sources(bubbleSortAssembly PRIVATE ${ASM_SOURCE_FILES})

# # Makefile of simple addition/multiplication project
# cmake_minimum_required(VERSION 3.0)
# project(AssemblyIntegration)

# # Set the project to use C
# enable_language(C)

# # Add the helloworld.c file
# add_executable(helloworld helloworld.c)

# # Add the assembly file
# enable_language(ASM)
# set(ASM_SOURCE_FILES helloworld.s)
# set_source_files_properties(${ASM_SOURCE_FILES} PROPERTIES LANGUAGE ASM)

# # Link the assembly file with the C file
# target_sources(helloworld PRIVATE ${ASM_SOURCE_FILES})

# # Makefile of c program calling assembly bubblesort project
# cmake_minimum_required(VERSION 3.0)
# project(bubbleSortAssembly)

# # Set the project to use C
# enable_language(C)

# # Add the bubbleSortAssembly.c file
# add_executable(bubbleSortAssembly bubbleSortAssembly.c)
...
# # Makefile of pure c bubblesort program
# cmake_minimum_required(VERSION 3.0)

# # Define your project name
# project(bubbleSort)

# # Specify the executable and the source file
# add_executable(bubbleSort bubbleSort.c)
```
...
```
<img width="569" alt="image" src="https://github.com/JamesYen220/test/assets/100248639/f02eedf3-74f9-47b1-9399-05a01222a5f8">  
